...
namespace IMAVD1
{
    class ChangeGamaButton : ToolButton
    {
        private Form1 form;
        public ChangeGamaButton(Form1 form) : base()
        {
            this.Click += new EventHandler(button_Click);
            this.form = form;
            this.BackgroundImage = IMAVD1.Properties.Resources.gamma_icon;
            this.BackgroundImageLayout = ImageLayout.Zoom;
            setToolTip("Change gamma");
        }
        ...
        protected void button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    form.createValuePickerMenu(this, "Adjust gamma (0-1)", "0", "1");
                }
            }
